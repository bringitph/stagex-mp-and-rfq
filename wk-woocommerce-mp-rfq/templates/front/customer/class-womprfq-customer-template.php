	...
	class Womprfq_Customer_Template {
		...
		public function womprfq_list_quote_template() {
			...
			<div class="quotation-list-wrapper">
				...
				<?php
				$quote_columns = array(
					// JS edit: On Buyers side, change Quotation ID header to Request ID when viewing list of all RFQs
					...
					// JS edit: Add Total Quotes received on buyers RFQ list header
			...
			<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
				...
				if ( ! empty( $customer_quotes ) ) {
					...
					// JS edit: Add Total Quotes received on buyers RFQ list
					...
					<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-processing order">
						<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-quote-id" data-title="<?php esc_attr_e( 'Quotation Id', 'wk-mp-rfq' ); ?>">
							<!-- JS edit: Make Request ID hyperlinked in Buyers RFQ list -->
						...
						<?php // JS edit: Add Total Quotes received on buyers RFQ list 
