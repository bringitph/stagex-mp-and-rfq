...
if ( ! class_exists( 'WKMP_Seller_Transaction_View' ) ) {
	...
	class WKMP_Seller_Transaction_View {
		...
		public function __construct( $id ) {
			...
			$this->wkmp_display_seller_transaction_view( $id );
		}
		...
		public function wkmp_display_seller_transaction_view( $id ) {
			$transaction_db_obj = new Common\WKMP_Transaction();
								...
								<fieldset>
									<div class="box-content">
										...
										<div class="wk_row">
											...
											<span class="value"><span class="price"><?php echo wp_kses_data( wc_price( apply_filters( 'wkmp_add_order_fee_to_total', $ord_id, $transaction_info->amount - $sel_info['refunded_amount'] ), array( 'currency' => $currency ) ) ); ?></span></span>
										</div>
					...
					<div class="transaction-details">
						<div class="table-wrapper">
							...
							<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
								...
								$subtotal          = apply_filters( 'wkmp_add_order_fee_to_total', $order->get_id(), $sel_info['total_seller_amount'] - $sel_info['refunded_amount'] );
								?>
								<tr>
									<td>
									...
									<td>
										...
										if ( $subtotal !== $line_total ) {
											...
											$tip  = apply_filters( 'wkmp_rfq_add_order_fee_to_tooltip', $order->get_id(), $tip );
