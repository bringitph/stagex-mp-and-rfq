...
<div class="woocommerce-account woocommerce">
	...
	<div id="main_container" class="woocommerce-MyAccount-content">
		...
		<div class="wkmp-table-responsive">
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<!-- JS edit: hide Action column in Transactions List 1/2 -->
				...
				<?php if ( $transactions ) { ?>
					<?php foreach ( $transactions as $key => $transaction ) { ?>
						<tr>
							...
							<!-- JS edit: hide Action column in Transactions List 2/2 -->
		...
		<?php echo wp_kses_post( $pagination['results'] ); ?>
		<?php echo wp_kses_post( $pagination['pagination'] ); ?>
