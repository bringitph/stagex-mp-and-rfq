					...
					<fieldset>
						<div class="box-content">
							...
							<div class="wk_row">
								...
								<span class="value"><span class="price"><?php echo wp_kses_data( wc_price( apply_filters( 'wkmp_add_order_fee_to_total', $order_info->get_id(), $transaction_info->amount - $seller_order_info['refunded_amount'] ), array( 'currency' => $order_info->get_currency() ) ) ); ?></span></span>
							</div>
				...
				<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
					...
					<tr>
						...
						<td>
							...
							<?php echo wp_kses_data( wc_price( apply_filters( 'wkmp_add_order_fee_to_total', $order_info->get_id(), $seller_order_info['total_seller_amount'] - $seller_order_info['refunded_amount'] ), array( 'currency' => $order_info->get_currency() ) ) ); ?>
						</td>
					</tr>
					</tbody>
