...
$total_discount  = array_sum( $com_data['discount'] );
...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . html_entity_decode( esc_html__( 'You have received an order from', 'wk-marketplace' ), ENT_QUOTES, 'UTF-8' ) . '&nbsp;' . $seller_order->get_formatted_billing_full_name() . '</p>
