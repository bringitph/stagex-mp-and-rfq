...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . html_entity_decode( /* translators: %1$d: Order number, %2$s: Billing full name.  */ sprintf( esc_html__( 'Alas. Just to let you know — order #%1$d belonging to %2$s has been cancelled:', 'wk-marketplace' ), esc_html( $seller_order->get_order_number() ), esc_html( $seller_order->get_formatted_billing_full_name() ) ), ENT_QUOTES, 'UTF-8' ) . '</p>
