...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . html_entity_decode( esc_html__( 'Thanks for your order. It is on-hold until we confirm that payment has been received. In the meantime, here is a reminder of what you ordered:', 'wk-marketplace' ), ENT_QUOTES, 'UTF-8' ) . '</p>
