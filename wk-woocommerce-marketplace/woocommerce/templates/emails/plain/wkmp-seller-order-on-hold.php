...
$result = utf8_decode( esc_html__( 'Thanks for your order. It is on-hold until we confirm that payment has been received. In the meantime, here is a reminder of what you ordered: ', 'wk-marketplace' ) ) . '&nbsp;' . utf8_decode( $seller_order->get_formatted_billing_full_name() ) . "\n\n" . 'Order #' . $seller_order->get_ID() . ' (' . $date_string . ') ' . "\n\n";
