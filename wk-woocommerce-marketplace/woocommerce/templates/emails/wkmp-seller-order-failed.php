...
$result = '
	<div style="margin-bottom: 40px;">
		<p>' . html_entity_decode( /* translators: %1$s Order number, %2$s Billing name. */ sprintf( esc_html__( 'Payment for order #%1$s from %2$s has failed. The order was as follows:', 'wk-marketplace' ), esc_html( $seller_order->get_order_number() ), esc_html( $seller_order->get_formatted_billing_full_name() ) ), ENT_QUOTES, 'UTF-8' ) . '</p>
